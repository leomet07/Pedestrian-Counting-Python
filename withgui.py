...
def clicked():
    ...
    print(label)
    total = cumulative_object_counting_x_axis(input_video, detection_graph, category_index,is_color_recognition_enabled,x,y,w,h,label ,write=False, display=True)
